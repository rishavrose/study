...
const Sidebar = () => {
    ...
    // Use dynamic menu context
    const { menus: apiMenus, loading: menuLoading, error: menuError, refetch: refetchMenus } = useMenuContext();
    ...
    const renderMenu = (items: FrontendMenuItem[], parentKey = '') =>
        items.map((item, idx) => {
            if (item.type === 'section') {
                console.log(`Rendering section: ${item}`); // Debugging line to check section rendering
                            ...
                            {menuLoading ? (
                                ...
                                <li className="text-center py-4">
                                    ...
                                    <button
                                        ...
                                        className="text-xs text-blue-500 hover:text-blue-700 mt-1 block mx-auto"
                                    >
                                        Retry
                                    </button>
                                </li>
